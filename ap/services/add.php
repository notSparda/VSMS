...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($is_valid) {
        ...
        $sql = "INSERT INTO services (name, description, price, duration_hours, provider_id) 
                VALUES ('$name', '$description', '$price', '$duration_hours', $provider_id_sql)";
...
<head>
    ...
    <title>Add New Service - Service Management System</title>
